...
<section class="teacher-profile">
   ...
   <div class="container">
        ...
        <form action="update_family_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter family id" name="family_id" required>
                        </div>
                        <div class="input-field_new">
                    ...
                    <%
                        try{
                            ...
                            PreparedStatement stmt = conn.prepareStatement("select * from family_col");
