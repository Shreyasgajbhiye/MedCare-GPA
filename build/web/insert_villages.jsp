...
<section class="teacher-profile">
   ...
   <div class="container">
        <header>Insert village</header>

        <form action="village_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        ...
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter village name" name="village_name" onkeypress="isInputChar(event)" required>
                        </div>

                        <div class="input-field_new">
                            <label>Code</label>
                            <input type="text" placeholder="Enter village code" name="code" onkeypress="isInputNumber(event)" required>
                        </div>
