...
<section class="teachers">
   ...
   <div class="box-container">
    ...
    <%
            ...
            String sql = "select * from family_archive";
            ...
            while(rs.next())
                {
                    out.println("<tr><td>"+rs.getString("family_id")+"</td><td>"+rs.getString("village")+"</td><td>"+rs.getString("address")
                    +"</td><td><a href='update_family.jsp'>Update</a></td>"
                    + "<td><a href='delete_family.jsp'>Delete</a></td></tr>");
