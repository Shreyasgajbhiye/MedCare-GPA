...
<section class="teachers">
   ...
   <div class="box-container">
    ...
    <%
            ...
            String sql = "select * from villages_archive";
            ...
            while(rs.next())
                {
                    out.println("<tr><td>"+rs.getString("village_id")+"</td><td>"+rs.getString("village_name")+"</td><td>"+rs.getInt("village_code")
                    +"</td><td><a href='update_village.jsp'>Update</a></td>"
                    + "<td><a href='delete_village.jsp'>Delete</a></td></tr>");
