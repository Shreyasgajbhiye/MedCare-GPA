...
<head>
   ...
   <link rel="stylesheet" href="css/style_table_1.css">
   ...
   <div class="box-container">
    ...
    <%
            ...
            ResultSet rs = stmt.executeQuery(sql);
                ...
                while(rs.next()){
                    out.println("<tr><td>"+rs.getString("patient_name")+"</td><td>"+rs.getString("symptoms")+"</td><td>"+rs.getString("med1")+" ("+rs.getInt("quantity_1")+"), "
                                                                                                                        +rs.getString("med2")+" ("+rs.getInt("quantity_2")+"), "
                                                                                                                        +rs.getString("med3")+" ("+rs.getInt("quantity_3")+"), "
                                                                                                                    +rs.getString("med4")+" ("+rs.getInt("quantity_4")+"), "
                                                                                                                        +rs.getString("med5")+" ("+rs.getInt("quantity_5")+"), "
                                                                                                                        +rs.getString("med6")+" ("+rs.getInt("quantity_6")+") "
                                                                                            
                                                                                                                        +"</td><td>"+rs.getString("date_time")+"</td>"
                                                                                                                        + "");
                                                                                                                        //+ "<td>"+"</td><td><a href='#'>Update</a></td>"+ "<td><a href='#'>Delete</a></td></tr>");
