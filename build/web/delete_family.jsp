...
<section class="teacher-profile">
   ...
   <h1 class="heading">Delete family information</h1>
   <div class="container">
        <header>Delete operation</header>

        <form action="delete_family_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter family id" name="f_id" required>
                        </div>
