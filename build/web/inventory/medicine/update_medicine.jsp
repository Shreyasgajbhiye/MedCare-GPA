...
<section class="teacher-profile">
   ...
   <div class="container">
        <header>Update family information</header>

        <form action="update_medicine_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter medicine name" name="med_id" onkeypress="isInputChar(event)" required>
                        </div>
                        <div class="input-field_new">
                    ...
                    <%
                        try{
                            ...
                            PreparedStatement stmt = conn.prepareStatement("select * from medicine_col");
