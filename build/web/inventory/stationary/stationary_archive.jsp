...
<section class="teachers">
   ...
   <div class="box-container">
    ...
    <%
            ...
            String sql = "select * from stationary_archive";
            ...
            while(rs.next())
                {
                    out.println("<tr><td>"+rs.getString("stationary_name")+"</td><td>"+rs.getInt("quantity")
                    +"</td><td>"+rs.getString("insert_date")+"</td><td><a href='update_stationary.jsp'>Update</a></td>"
                    + "<td><a href='delete_stationary.jsp'>Delete</a></td></tr>");
