    ...
    <body>
       ...
       %>
        ...
        <%@ page import="pkg.connect" %>
         ...
         <%
            String St_name = request.getParameter("st_name").toUpperCase();
...
//new
            ...
            PreparedStatement stmt = connection.prepareStatement("update stationary set "+col+" = ?  where stationary_name = ?");
...
//new
int quantity =0;
            quantity =  Integer.parseInt(updated);
            connect conn = new connect();
            Connection connection = conn.createConnection();
            PreparedStatement stmt = connection.prepareStatement("update stationary set "+col+" = ?  where stationary_name = ?");
