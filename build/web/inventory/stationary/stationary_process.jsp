    ...
    <body>
       ...
       %>
        ...
        <%@ page import="pkg.connect" %>
         ...
         <%
            String name = request.getParameter("stationary_name").toUpperCase();
            int qty = Integer.parseInt(request.getParameter("quantity"));
            String sql = "select * from stationary where stationary_name = '"+name+"'";
            connect conn = new connect();
            Connection connection = conn.createConnection();
            
            
            
            PreparedStatement stmt = connection.prepareStatement("insert into stationary (stationary_name , quantity) values (?,?)");
         ...
         <script>
                {
                swal("Error","Stationary item already exist", "error");
                }
                 </script>
            <%
             }
