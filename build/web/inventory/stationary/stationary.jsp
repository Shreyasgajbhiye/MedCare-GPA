...
<section class="teacher-profile">
   ...
   <h1 class="heading">Insert stationary</h1>
   <div class="container">
        <header>Insert stationary</header>

        <form action="stationary_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        ...
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter stationary name" name="stationary_name" onkeypress="isInputChar(event)" required>
                        </div>
