...
<section class="teacher-profile">
   ...
   <div class="container">
        <header>Update stationary information</header>

        <form action="update_stationar_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter stationary name " name="st_name" onkeypress="isInputChar(event)" required>
                        </div>
                        <div class="input-field_new">
                    ...
                    <%
                        try{
                            ...
                            PreparedStatement stmt = conn.prepareStatement("select * from column_stationary");
