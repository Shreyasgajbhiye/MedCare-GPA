...
<section class="teacher-profile">
   ...
   <h1 class="heading">Insert disposable</h1>
   <div class="container">
        <header>Insert disposable information</header>

        <form action="disposable_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        ...
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter disposable name" name="disposable_name" onkeypress="isInputChar(event)" required>
                        </div>
