...
<head>
   ...
   <link rel="stylesheet" href="family_form.css">
...
<section class="teacher-profile">
   ...
   <div class="container">
        <header>Update disposable information</header>

        <form action="update_disposable_process.jsp" method="post">
            <div class="form first">
                <div class="details personal">

                    <div class="fields_new">
                        <div class="input-field_new">
                            <label>Disposable name</label>
                            <input type="text" placeholder="Enter disposable name" name="d_name" onkeypress="isInputChar(event)" required>
                        </div>
                        <div class="input-field_new">
                    ...
                    <%
                        try{
                            ...
                            PreparedStatement stmt = conn.prepareStatement("select * from column_disposable");
