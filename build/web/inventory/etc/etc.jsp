...
<section class="teacher-profile">
   ...
   <h1 class="heading">Insert other items</h1>
   <div class="container">
        <header>Insert other items</header>

        <form action="etc_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        ...
                        <div class="input-field_new">
                            <label>Item</label>
                            <input type="text" placeholder="What's that ?" name="etc_name"  onkeypress="isInputChar(event)" required>
                        </div>
