...
<section class="teacher-profile">
   ...
   <h1 class="heading">Delete village</h1>
   <div class="container">
        <header>Delete operation</header>

        <form action="delete_village_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter village id" name="village_id" required>
                        </div>
