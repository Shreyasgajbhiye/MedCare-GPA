...
<section class="teachers">
   ...
   <div class="box-container">
    ...
    <%
            ...
            while(rs.next())
                {
                    out.println("<tr><td>"+rs.getString("id")+"</td><td>"+rs.getString("first_name")+" "+rs.getString("last_name")+"</td><td>"+rs.getString("email")+"</td><td><a href='update_user.jsp'>Update</a></td>"
