...
<section class="teacher-profile">
   ...
   <div class="container">
        <header>Print data in excel format</header>

        <form action="print_database_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <%
                        try{
                            ...
                            PreparedStatement stmt = conn.prepareStatement("select * from column_print_database");
