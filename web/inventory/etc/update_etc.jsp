...
<section class="teacher-profile">
   ...
   <div class="container">
        <header>Update other item information</header>

        <form action="update_etc_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter item name" name="item" onkeypress="isInputChar(event)" required>
                        </div>
                        <div class="input-field_new">
                    ...
                    <%
                        try{
                            ...
                            PreparedStatement stmt = conn.prepareStatement("select * from column_etc");
