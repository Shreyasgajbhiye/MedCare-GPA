    ...
    <body>
       ...
       %>
        ...
        <%@ page import="pkg.connect" %>
         ...
         <%
            String name = request.getParameter("etc_name").toUpperCase();
            int qty = Integer.parseInt(request.getParameter("quantity"));
            String sql = "select * from etc where etc_name = '"+name+"'";
            connect conn = new connect();
            Connection connection = conn.createConnection();
            PreparedStatement stmt = connection.prepareStatement("insert into etc (etc_name , quantity) values (?,?)");
