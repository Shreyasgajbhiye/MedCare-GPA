...
<section class="teacher-profile">
   ...
   <h1 class="heading">Delete item</h1>
   <div class="container">
        <header>Delete operation</header>

        <form action="delete_etc_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter item name" name="item_name" onkeypress="isInputChar(event)" required>
                        </div>
