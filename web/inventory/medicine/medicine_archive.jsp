...
<section class="teachers">
   ...
   <div class="box-container">
    ...
    <%
            ...
            String sql = "select * from medicine_archive";
            ...
            while(rs.next())
                {
                    out.println("<tr><td>"+rs.getString("medicine_id")+"</td><td>"+rs.getString("medicine_name")+"</td><td>"+rs.getInt("quantity")
                    +"</td><td>"+rs.getString("insert_date")+"</td><td>"+rs.getString("expiry_date")+"</td><td><a href='update_medicine.jsp'>Update</a></td>"
                    + "<td><a href='delete_medicine.jsp'>Delete</a></td></tr>");
