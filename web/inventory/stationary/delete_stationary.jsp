...
<div class="side-bar">
   ...
   <div class="profile">
      <img src="images/pic-1.jpg" class="image" alt="">
      <h3 class="name">Static</h3>
      <p class="role">static</p>
      <a href="../../profile.jsp" class="btn">view profile</a>
   </div>
...
<section class="teacher-profile">
   ...
   <h1 class="heading">Delete stationary</h1>
   <div class="container">
        <header>Delete operation</header>

        <form action="delete_stationary_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <div class="fields_new">
                        <div class="input-field_new">
                            ...
                            <input type="text" placeholder="Enter medicine name" name="st_id" onkeypress="isInputChar(event)" required>
                        </div>
