...
<section class="teachers">
   ...
   <div class="box-container">
    ...
    <%
            ...
            String sql = "select * from disposable_archive";
            ...
            while(rs.next())
                {
                    out.println("<tr><td>"+rs.getString("disposable_name")+"</td><td>"+rs.getInt("quantity")
                    +"</td><td>"+rs.getString("insert_date")+"</td><td><a href='update_disposable.jsp'>Update</a></td>"
                    + "<td><a href='delete_disposable.jsp'>Delete</a></td></tr>");
