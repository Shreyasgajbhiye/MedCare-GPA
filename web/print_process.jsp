...
<html>
    <head>
        ...
        <title>Print process page</title>
    ...
    <body>
       ...
       %>
         ...
         <%
            ...
            String sql = "copy public."+col+" to 'D:\\"+col+".csv' delimiter ',' csv header";
            ...
            %>
                <script>
                {
                swal("Error","File not created", "error");
                }
                 </script>
            <%
            }
                ...
                <script>
                {
                swal("Success","File created", "success");
                }
                 </script>
            <%
            }
...
<div class="side-bar">
   ...
   <h1 class="heading">Successfully saved!!</h1>
   <div class="container">
        <header>Go back!!</header>
        <header>D:\\<%out.print(col);%>.csv</header>
    </div>
</section>
</body>
</html>
