...
<section class="teacher-profile">
   ...
   <div class="container">
        <header>Create new family</header>

        <form action="family_process.jsp" method="post">
                ...
                <div class="details personal">
                    ...
                    <%
                        try{
                            ...
                            PreparedStatement stmt = conn.prepareStatement("select * from villages");
                            ...
                            while(rs.next()){
                            %>
                            <option><%=rs.getString("village_name")%></option>
                            <%
                        }
                        }
                        catch(Exception e){    
